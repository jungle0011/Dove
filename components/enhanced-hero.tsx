...
export default function EnhancedHero() {
  const handleBookSession = () => {
    openWhatsAppChat(
      "Hello Prophetess Blessing Ngozichukwu, I would like to book a sacred session through the Dove Platform.",
    )
  }

  const handlePrayerRequest = () => {
    openWhatsAppChat(
      "Hello Prophetess Blessing Ngozichukwu, I would like to submit a prayer request through the Dove Platform.",
    )
  }
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 relative">
          ...
          <h1 className="relative text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-light text-gray-800 dark:text-white mb-6 leading-tight">
            Welcome to{" "}
          ...
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-700 dark:text-gray-200 mb-4 max-w-4xl mx-auto leading-relaxed font-light">
            A sanctuary for healing, prophecy, and divine guidance
          </p>

          <p className="text-lg md:text-xl text-amber-600 dark:text-amber-400 font-medium">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-16">
          <Button
            ...
            size="lg"
            className="group bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-500 hover:from-amber-600 hover:via-yellow-600 hover:to-amber-600 text-white px-8 sm:px-10 py-3 sm:py-4 rounded-full transition-all duration-500 transform hover:scale-105 hover:shadow-2xl hover:shadow-amber-500/25 text-base sm:text-lg font-medium glow-on-scroll animate-gentle-pulse w-full sm:w-auto min-h-[48px]"
          >
