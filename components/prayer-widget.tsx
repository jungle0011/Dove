...
export default function PrayerWidget() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const formattedMessage = `Prayer Request:\nName: ${isAnonymous ? "Anonymous" : name}\nRequest: ${prayerRequest}`
    const whatsappLink = `https://wa.me/2348037493749?text=${encodeURIComponent(formattedMessage)}`
    ...
    >
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300">Share your heart with our prayer community</p>
        </div>
            ...
            <CardContent>
              {isSubmitted ? (
                <div className="text-center py-8">
                  ...
                  <h3 className="text-lg font-medium text-gray-800 dark:text-white mb-2">Prayer Added 🔥</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                    Your request has been lifted up in prayer by Prophetess Blessing Ngozichukwu.
                  </p>
